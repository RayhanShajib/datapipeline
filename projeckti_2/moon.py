...
# Audio setup
pygame.mixer.init()
pygame.mixer.music.load("masseffect_map_music.mp3")
...
# Kernest-2: Smooth, faster path
k2_x = np.linspace(8, moon_pos[0], frames)
k2_y = (time / 1.25)
...
kernest_plot, = ax.plot([], [], 'bo', markersize=10, label='Kernest-2')

countdown_text = ax.text(5, 2, '', fontsize=20, ha='center',
                         color='darkorange', fontweight='bold')
status_msg = ax.text(5, -6.5, 'Status: Pre-launch', ha='center',
